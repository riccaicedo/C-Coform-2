Public Class Pulpa
    ...
    Public HCenterlining = libro.Worksheets("BD DESENRROLLADORES")
...
#Region "Envio de Datos"
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or
            ...
            TextBox31.Text = "" Or TextBox32.Text = "" Or TextBox33.Text = "" Or TextBox34.Text = "" Or CBTurno.Text = "" Or CBSupervisor.Text = "" Or
...
#End Region
                    ...
                    'Si la variable es igual a Cero esta inativo el desenrrollador imprime * de lo contrario inserta la variable
                    If Convert.ToDecimal(VariablesFormacion) = 0 Then
                        HCenterlining.cells(Final, Ucolumna - textb) = "*"
                    Else
                        ' Inserta las variables
                        HCenterlining.Cells(Final, Ucolumna - textb) = Convert.ToDecimal(VariablesFormacion)
                    End If

                    ' examina todas la variables que sean direntes de 0
                    If Convert.ToDecimal(VariablesFormacion) <> 0 Then
