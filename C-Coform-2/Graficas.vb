...
Public Class Graficas
    ...
    Public Hoja1 = libro.Worksheets("BD FORMACION")
    Public Hoja2 = libro.Worksheets("BD EXTRUSION")
    Public Hoja3 = libro.Worksheets("BD DESENRROLLADORES")
    Public Hoja4 = libro.Worksheets("BD CALAN Y WINDER")
    Public Hoja5 = libro.Worksheets("BD MALLAS")
...
#Region "Funciones ComboBox"
    ...
    Private Sub CBModulo_Enter(sender As Object, e As EventArgs) Handles CBModulo.Enter
        ...
        Me.CBModulo.Items.Add("BD FORMACION")
        Me.CBModulo.Items.Add("BD EXTRUSION")
        Me.CBModulo.Items.Add("BD DESENRROLLADORES")
        Me.CBModulo.Items.Add("BD CALAN Y WINDER")
    ...
    Private Sub CBModulo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBModulo.SelectedIndexChanged
        If Me.CBModulo.Text = "HE" Then
            DRango = HE
        End If
        If Me.CBModulo.Text = "BD FORMACION" Then
            DRango = Hoja1
        End If
        If Me.CBModulo.Text = "BD EXTRUSION" Then
            DRango = Hoja2
        End If
        If Me.CBModulo.Text = "BD DESENRROLLADORES" Then
            DRango = Hoja3
        End If
        If Me.CBModulo.Text = "BD CALAN Y WINDER" Then
            DRango = Hoja4
        End If
    End Sub
    ...
    Private Sub CBRef_Enter(sender As Object, e As EventArgs) Handles CBRef.Enter
        ...
        Else
            ...
            Me.CBRef.Items.Add("35")
            Me.CBRef.Items.Add("50")
            Me.CBRef.Items.Add("63")
        End If
...
#End Region
    ...
    Private Sub btnPuntos_MouseClick(sender As Object, e As MouseEventArgs) Handles btnPuntos.MouseClick
        ...
        Else
            MsgBox("Debe exitir una grafica ")
        End If
