Public Class Formacion
    ...
    Public HCenterlining = libro.Worksheets("BD FORMACION")
...
#Region "Envio de Datos"
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or
            ...
            TextBox31.Text = "" Or TextBox32.Text = "" Or TextBox33.Text = "" Or TextBox34.Text = "" Or TextBox35.Text = "" Or
            TextBox36.Text = "" Or TextBox37.Text = "" Or TextBox38.Text = "" Or TextBox39.Text = "" Or TextBox40.Text = "" Or
            TextBox41.Text = "" Or TextBox42.Text = "" Or TextBox43.Text = "" Or TextBox44.Text = "" Or TextBox45.Text = "" Or
            TextBox46.Text = "" Or TextBox47.Text = "" Or TextBox48.Text = "" Or CBTurno.Text = "" Or CBSupervisor.Text = "" Or
...
#Region "label formacion"
                    If textb = 1 Then
                            LabelFormacion = Label51.Text
                        End If
                        If textb = 2 Then
                            LabelFormacion = Label50.Text
                        End If
                        If textb = 3 Then
                            LabelFormacion = Label49.Text
                        End If
                        If textb = 4 Then
                            LabelFormacion = Label48.Text
                        End If
                        If textb = 5 Then
                            LabelFormacion = Label47.Text
                        End If
                        If textb = 6 Then
                            LabelFormacion = Label46.Text
                        End If
                        If textb = 7 Then
                            LabelFormacion = Label45.Text
                        End If
                        If textb = 8 Then
                            LabelFormacion = Label44.Text
                        End If
                        If textb = 9 Then
                            LabelFormacion = Label43.Text
                        End If
                        If textb = 10 Then
                            LabelFormacion = Label42.Text
                        End If
                        If textb = 11 Then
                            LabelFormacion = Label41.Text
                        End If
                        If textb = 12 Then
                            LabelFormacion = Label40.Text
                        End If
                        If textb = 13 Then
                            LabelFormacion = Label39.Text
                        End If
                        If textb = 14 Then
                            LabelFormacion = Label38.Text
                        End If
                        If textb = 15 Then
                            LabelFormacion = Label37.Text
                        End If
                        If textb = 16 Then
                            LabelFormacion = Label36.Text
                        End If
                        If textb = 17 Then
                            LabelFormacion = Label35.Text
                        End If
                        If textb = 18 Then
                            LabelFormacion = Label34.Text
                        End If
                        If textb = 19 Then
                            LabelFormacion = Label33.Text
                        End If
                        If textb = 20 Then
                            LabelFormacion = Label32.Text
                        End If
                        If textb = 21 Then
                            LabelFormacion = Label31.Text
                        End If
                        If textb = 22 Then
                            LabelFormacion = Label30.Text
                        End If
                        If textb = 23 Then
                            LabelFormacion = Label29.Text
                        End If
                        If textb = 24 Then
                            LabelFormacion = Label28.Text
                        End If
                        If textb = 25 Then
                            LabelFormacion = Label27.Text
                        End If
                        If textb = 26 Then
                            LabelFormacion = Label26.Text
                        End If
                        If textb = 27 Then
                            LabelFormacion = Label25.Text
                        End If
                        If textb = 28 Then
                            LabelFormacion = Label24.Text
                        End If
                        If textb = 29 Then
                            LabelFormacion = Label23.Text
                        End If
                        If textb = 30 Then
                            LabelFormacion = Label22.Text
                        End If
                        If textb = 31 Then
                            LabelFormacion = Label21.Text
                        End If
                        If textb = 32 Then
...
#Region "Limpieza de TextBox"
            ...
            TextBox32.Text = vbNullChar
            TextBox33.Text = vbNullChar
            TextBox34.Text = vbNullChar
            TextBox35.Text = vbNullChar
            TextBox36.Text = vbNullChar
            TextBox37.Text = vbNullChar
            TextBox38.Text = vbNullChar
            TextBox39.Text = vbNullChar
...
#Region "Condicion para insertar solo Numeros"
    ...
    End Sub
    Private Sub TextBox32_Enter(sender As Object, e As EventArgs) Handles TextBox32.Enter
        TextBox32.SelectionStart = 0
        TextBox32.SelectionLength = TextBox32.Text.Length
    End Sub
    Private Sub TextBox33_Enter(sender As Object, e As EventArgs) Handles TextBox33.Enter
        TextBox33.SelectionStart = 0
        TextBox33.SelectionLength = TextBox33.Text.Length
    End Sub
    Private Sub TextBox34_Enter(sender As Object, e As EventArgs) Handles TextBox34.Enter
        TextBox34.SelectionStart = 0
        TextBox34.SelectionLength = TextBox34.Text.Length
    End Sub
    Private Sub TextBox35_Enter(sender As Object, e As EventArgs) Handles TextBox35.Enter
        TextBox35.SelectionStart = 0
        TextBox35.SelectionLength = TextBox35.Text.Length
    End Sub
    Private Sub TextBox36_Enter(sender As Object, e As EventArgs) Handles TextBox36.Enter
        TextBox36.SelectionStart = 0
        TextBox36.SelectionLength = TextBox36.Text.Length
    End Sub
    Private Sub TextBox37_Enter(sender As Object, e As EventArgs) Handles TextBox37.Enter
        TextBox37.SelectionStart = 0
        TextBox37.SelectionLength = TextBox37.Text.Length
    End Sub
    Private Sub TextBox38_Enter(sender As Object, e As EventArgs) Handles TextBox38.Enter
        TextBox38.SelectionStart = 0
        TextBox38.SelectionLength = TextBox38.Text.Length
    End Sub
    Private Sub TextBox39_Enter(sender As Object, e As EventArgs) Handles TextBox39.Enter
        TextBox39.SelectionStart = 0
        TextBox39.SelectionLength = TextBox39.Text.Length
    End Sub
    Private Sub TextBox40_Enter(sender As Object, e As EventArgs) Handles TextBox40.Enter
        TextBox40.SelectionStart = 0
        TextBox40.SelectionLength = TextBox40.Text.Length
    End Sub
    Private Sub TextBox41_Enter(sender As Object, e As EventArgs) Handles TextBox41.Enter
        TextBox41.SelectionStart = 0
        TextBox41.SelectionLength = TextBox41.Text.Length
    End Sub
    Private Sub TextBox42_Enter(sender As Object, e As EventArgs) Handles TextBox42.Enter
        TextBox42.SelectionStart = 0
        TextBox42.SelectionLength = TextBox42.Text.Length
    End Sub
    Private Sub TextBox43_Enter(sender As Object, e As EventArgs) Handles TextBox43.Enter
        TextBox43.SelectionStart = 0
        TextBox43.SelectionLength = TextBox43.Text.Length
    End Sub
    Private Sub TextBox44_Enter(sender As Object, e As EventArgs) Handles TextBox44.Enter
        TextBox44.SelectionStart = 0
        TextBox44.SelectionLength = TextBox44.Text.Length
    End Sub
    Private Sub TextBox45_Enter(sender As Object, e As EventArgs) Handles TextBox45.Enter
        TextBox45.SelectionStart = 0
        TextBox45.SelectionLength = TextBox45.Text.Length
    End Sub
    Private Sub TextBox46_Enter(sender As Object, e As EventArgs) Handles TextBox46.Enter
        TextBox46.SelectionStart = 0
        TextBox46.SelectionLength = TextBox46.Text.Length
    End Sub
    Private Sub TextBox47_Enter(sender As Object, e As EventArgs) Handles TextBox47.Enter
        TextBox47.SelectionStart = 0
        TextBox47.SelectionLength = TextBox47.Text.Length
    End Sub
    Private Sub TextBox48_Enter(sender As Object, e As EventArgs) Handles TextBox48.Enter
