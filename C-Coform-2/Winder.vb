Public Class Winder
    ...
    Public HCenterlining = libro.Worksheets("BD CALAN Y WINDER")
...
#Region "Envio de Datos"
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or
            ...
            TextBox16.Text = "" Or TextBox17.Text = "" Or TextBox18.Text = "" Or TextBox20.Text = "" Or TextBox19.Text = "" Or
...
#Region "Condicion para insertar solo Numeros"
    ...
    End Sub
    Private Sub TextBox19_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox20.KeyPress
        Call condicion(TextBox20, e)
    End Sub
    Private Sub TextBox20_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox19.KeyPress
